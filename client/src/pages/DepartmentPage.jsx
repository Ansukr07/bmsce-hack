...
import {
  ...
  ChevronRight, Mail, Phone, MapPin, BookOpen, Layers, User, Calendar, Trophy, Activity, Briefcase, FlaskConical, Info
} from 'lucide-react';
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col lg:flex-row gap-8 lg:gap-12 relative items-start">
        ...
        <div className={`lg:w-[320px] shrink-0 ${isMobileMenuOpen ? 'block' : 'hidden lg:block'}`}>
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    window.scrollTo({ top: window.innerWidth < 1024 ? 400 : 0, behavior: 'smooth' });
                  }}
          ...
          <div className="hidden lg:block mt-6 bg-[#111111] text-white rounded-3xl p-6 shadow-sm sticky top-[460px]">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4">Contact HR</h3>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Mail className="w-4 h-4 text-gray-400 mt-1" />
                <a href={`mailto:${data.hod.email}`} className="text-sm text-gray-300 hover:text-white transition-colors">{data.hod.email}</a>
              </div>
              <div className="flex items-start gap-3">
            ...
            >
              ...
              {activeTab === 'about' && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tight text-[#111111] mb-4">About the Department</h2>
              ...
              {activeTab === 'syllabus' && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tight text-[#111111] mb-4">Autonomous Syllabus</h2>
                    <div className="w-12 h-1.5 rounded-full" style={{ backgroundColor: accent }} />
                  </div>
              ...
              {activeTab === 'faculty' && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tight text-[#111111] mb-4">Faculty Details</h2>
                    <div className="w-12 h-1.5 rounded-full" style={{ backgroundColor: accent }} />
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {data.faculty.map((member, i) => (
                      <div key={i} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-[#FB6D39] transition-colors flex flex-col gap-4">
                        ...
                        <a href={`mailto:${member.email}`} className="text-[12px] text-gray-500 hover:text-[#111111] flex items-center gap-2 pt-4 border-t border-gray-100">
              ...
              {['timetable', 'achievements', 'activities', 'placements'].includes(activeTab) && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tight text-[#111111] mb-4">
                  ...
                  <div className="bg-gray-50 border border-gray-100 border-dashed rounded-3xl p-16 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm text-gray-500 max-w-sm">Detailed information for this section is currently being updated by the department administration.</p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'rnd' && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tight text-[#111111] mb-4">R & D and Facilities</h2>
                    <div className="w-12 h-1.5 rounded-full" style={{ backgroundColor: accent }} />
                  </div>
